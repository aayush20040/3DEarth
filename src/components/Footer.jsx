            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-4 text-lg font-semibold text-gray-300 ">Company</h2>
                            <ul className="text-gray-500 font-medium">
                                ...
                                <li className="mb-4">
                                    <a href="/Newsroom" className=" text-gray-400 hover:underline">
                                        Newsroom
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div>
                            <h2 className="mb-6 text-lg font-semibold text-gray-300 ">Resources</h2>
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <a
                                        href=""
